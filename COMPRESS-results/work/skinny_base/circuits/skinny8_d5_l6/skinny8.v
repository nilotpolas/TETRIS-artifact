...
MSKand_hpc2_swapped #(.d(d)) comp_t2_3 (
    .out(t2_3),
...
MSKand_hpc2_swapped #(.d(d)) comp_t3_4 (
    .out(t3_4),
...
MSKand_hpc2_swapped #(.d(d)) comp_t5_5 (
    .out(t5_5),
...
MSKand_hpc2_swapped #(.d(d)) comp_t7_6 (
    .out(t7_6),
