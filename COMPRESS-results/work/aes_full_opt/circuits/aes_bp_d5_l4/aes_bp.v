...
MSKand_hpc3o_swapped #(.d(d)) comp_m9_1 (
    .out(m9_1),
...
MSKand_hpc3o_swapped #(.d(d)) comp_m11_1 (
    .out(m11_1),
...
MSKand_hpc3o_swapped #(.d(d)) comp_m14_1 (
    .out(m14_1),
...
MSKand_hpc3o_swapped #(.d(d)) comp_m25_2 (
    .out(m25_2),
    .rnd(rnd_1[0 +: 1*d*(d-1)]),
    .ina(m22_1),
    .inb(m20_1),
...
MSKand_hpc2o_cross #(.d(d)) comp_m29_cross_3 (
    .out(m29_cross_3),
    .rnd(rnd_1[3*(1*d*(d-1)) +: 1*d*(d-1)/2]),
    .ina(m28_2),
    .inb(m27_1),
    .clk(clk)
);
...
MSKand_hpc2o_cross #(.d(d)) comp_m30_cross_3 (
    .out(m30_cross_3),
    .rnd(rnd_1[3*(1*d*(d-1))+1*(1*d*(d-1)/2) +: 1*d*(d-1)/2]),
    .ina(m26_2),
    .inb(m24_1),
    .clk(clk)
);
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_m32_cross_3 (
    .out(m32_cross_3),
    .rnd(rnd_1[3*(1*d*(d-1))+2*(1*d*(d-1)/2) +: 1*d*(d-1)/2]),
    .ina(m27_1),
    .inb(m31_2),
    .clk(clk)
);
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_m35_cross_3 (
    .out(m35_cross_3),
...
MSKand_hpc2o_cross #(.d(d)) comp_m46_cross_4 (
    .out(m46_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m47_cross_4 (
    .out(m47_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m48_cross_4 (
    .out(m48_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m49_cross_4 (
    .out(m49_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m50_cross_4 (
    .out(m50_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m51_cross_4 (
    .out(m51_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m52_cross_4 (
    .out(m52_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m53_cross_4 (
    .out(m53_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m54_cross_4 (
    .out(m54_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m55_cross_4 (
    .out(m55_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m56_cross_4 (
    .out(m56_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m57_cross_4 (
    .out(m57_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m58_cross_4 (
    .out(m58_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m59_cross_4 (
    .out(m59_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m60_cross_4 (
    .out(m60_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m61_cross_4 (
    .out(m61_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m62_cross_4 (
    .out(m62_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_m63_cross_4 (
    .out(m63_cross_4),
