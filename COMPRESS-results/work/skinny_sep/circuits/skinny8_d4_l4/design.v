...
MSKand_hpc3_cross_er #(.d(d)) comp_t0_cross_1 (
    .out(t0_cross_1),
    .rnd(rnd_0[0 +: 1*d*(d-1)]),
    .ina(n6_0),
    .ina_prev(n6_1),
...
MSKand_hpc3_cross_er #(.d(d)) comp_t1_cross_1 (
    .out(t1_cross_1),
...
MSKand_hpc3_cross_er #(.d(d)) comp_t3_cross_2 (
    .out(t3_cross_2),
    .rnd(rnd_1[0 +: 1*d*(d-1)]),
    .ina(nt0_1),
    .ina_prev(nt0_2),
...
MSKand_hpc3_cross_er_swapped #(.d(d)) comp_t5_cross_3 (
    .out(t5_cross_3),
    .rnd(rnd_2[0 +: 1*d*(d-1)]),
    .ina(nt2_2),
    .inb(nt3_2),
