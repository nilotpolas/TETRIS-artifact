...
MSKxor #(.d(d)) comp_t3_3 (
    .out(t3_3),
    .ina(t3_cross_3),
    .inb(t3_inner_3)
);
MSKxor #(.d(d)) comp_t4_3 (
    .out(t4_3),
    .ina(t4_cross_3),
    .inb(t4_inner_3)
);
...
MSKxor #(.d(d)) comp_t6_4 (
    .out(t6_4),
    .ina(t6_cross_4),
    .inb(t6_inner_4)
);
MSKxor #(.d(d)) comp_t7_5 (
    .out(t7_5),
    .ina(t7_cross_5),
    .inb(t7_inner_5)
);
...
MSKand_hpc2_cross #(.d(d)) comp_t0_cross_2 (
    .out(t0_cross_2),
...
MSKand_hpc2_cross #(.d(d)) comp_t1_cross_2 (
    .out(t1_cross_2),
...
MSKand_hpc3_cross_er #(.d(d)) comp_t3_cross_3 (
    .out(t3_cross_3),
    .rnd(rnd_2[0 +: 1*d*(d-1)]),
    .ina(nt0_2),
    .ina_prev(nt0_3),
...
MSKand_hpc2_cross #(.d(d)) comp_t4_cross_3 (
    .out(t4_cross_3),
...
MSKand_sharewise #(.d(d)) comp_t4_inner_2 (
    .out(t4_inner_2),
    .ina(nt1_2),
    .inb(n3_2)
);
MSKand_hpc2_cross_swapped #(.d(d)) comp_t5_cross_4 (
    .out(t5_cross_4),
...
MSKand_sharewise #(.d(d)) comp_t5_inner_3 (
    .out(t5_inner_3),
    .ina(nt2_3),
    .inb(nt3_3)
);
MSKand_hpc2_cross #(.d(d)) comp_t6_cross_4 (
    .out(t6_cross_4),
...
MSKand_sharewise #(.d(d)) comp_t6_inner_3 (
    .out(t6_inner_3),
    .ina(nt3_3),
    .inb(nt0_3)
);
MSKand_hpc2_cross_swapped #(.d(d)) comp_t7_cross_5 (
    .out(t7_cross_5),
...
MSKand_sharewise #(.d(d)) comp_t7_inner_4 (
    .out(t7_inner_4),
    .ina(nt4_4),
    .inb(nt5_4)
);
MSKreg #(.d(d)) reg_nt4_3 (
    .in(nt4_3),
    .out(nt4_4),
    .clk(clk)
);
