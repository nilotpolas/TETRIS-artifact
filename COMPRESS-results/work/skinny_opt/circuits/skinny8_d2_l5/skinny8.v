...
MSKand_hpc2o_swapped #(.d(d)) comp_t2_2 (
    .out(t2_2),
...
MSKand_hpc2o_swapped #(.d(d)) comp_t5_4 (
    .out(t5_4),
...
MSKand_hpc2o_swapped #(.d(d)) comp_t7_5 (
    .out(t7_5),
