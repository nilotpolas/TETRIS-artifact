...
MSKand_hpc2o_cross #(.d(d)) comp_t1_cross_3 (
    .out(t1_cross_3),
...
MSKand_sharewise #(.d(d)) comp_t1_inner_3 (
    .out(t1_inner_3),
    .ina(n3_3),
    .inb(n2_3)
);
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t2_cross_3 (
    .out(t2_cross_3),
...
MSKand_sharewise #(.d(d)) comp_t2_inner_3 (
    .out(t2_inner_3),
    .ina(n2_3),
    .inb(n1_3)
);
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t3_cross_4 (
    .out(t3_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_t4_cross_4 (
    .out(t4_cross_4),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t5_cross_5 (
    .out(t5_cross_5),
...
MSKand_hpc2o_cross #(.d(d)) comp_t6_cross_5 (
    .out(t6_cross_5),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t7_cross_6 (
    .out(t7_cross_6),
