...
(* fv_type="sharing", fv_latency=4, fv_count=1 *)
output [d-1:0] o7;
(* fv_type="random", fv_count=1, fv_rnd_count_0=3*(1*d*(d-1))+1*(1*d*(d-1)/2), fv_rnd_lat_0=0  *)
input [3*(1*d*(d-1))+1*(1*d*(d-1)/2)-1:0] rnd_0;
(* fv_type="random", fv_count=1, fv_rnd_count_0=1*(1*d*(d-1))+2*(1*d*(d-1)/2), fv_rnd_lat_0=1  *)
input [1*(1*d*(d-1))+2*(1*d*(d-1)/2)-1:0] rnd_1;
(* fv_type="random", fv_count=1, fv_rnd_count_0=1*(1*d*(d-1)/2), fv_rnd_lat_0=2  *)
input [1*(1*d*(d-1)/2)-1:0] rnd_2;
wire [d-1:0] i0_0;
wire [d-1:0] i0_1;
wire [d-1:0] i1_0;
wire [d-1:0] i1_1;
...
MSKand_hpc3o_swapped #(.d(d)) comp_t0_1 (
    .out(t0_1),
    .rnd(rnd_0[0 +: 1*d*(d-1)]),
    .ina(n6_0),
    .inb(n7_0),
...
MSKinv #(.d(d)) comp_nt2_1 (
    .out(nt2_1),
    .in(t2_1)
);
MSKand_hpc3o #(.d(d)) comp_t3_2 (
    .out(t3_2),
    .rnd(rnd_1[0 +: 1*d*(d-1)]),
    .ina(nt0_1),
    .ina_prev(nt0_2),
...
MSKand_hpc2o_cross #(.d(d)) comp_t4_cross_2 (
    .out(t4_cross_2),
    .rnd(rnd_0[3*(1*d*(d-1)) +: 1*d*(d-1)/2]),
    .ina(nt1_1),
    .inb(n3_0),
    .clk(clk)
);
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t5_cross_3 (
    .out(t5_cross_3),
...
MSKand_hpc2o_cross #(.d(d)) comp_t6_cross_3 (
    .out(t6_cross_3),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t7_cross_4 (
    .out(t7_cross_4),
