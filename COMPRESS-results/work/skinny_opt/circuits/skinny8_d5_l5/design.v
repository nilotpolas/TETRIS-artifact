...
MSKand_hpc2o_cross #(.d(d)) comp_t0_cross_2 (
    .out(t0_cross_2),
...
MSKand_hpc2o_cross #(.d(d)) comp_t1_cross_2 (
    .out(t1_cross_2),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t2_cross_2 (
    .out(t2_cross_2),
...
MSKand_hpc2o_cross #(.d(d)) comp_t4_cross_3 (
    .out(t4_cross_3),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t5_cross_4 (
    .out(t5_cross_4),
...
MSKand_hpc2o_cross #(.d(d)) comp_t6_cross_4 (
    .out(t6_cross_4),
...
MSKand_hpc2o_cross_swapped #(.d(d)) comp_t7_cross_5 (
    .out(t7_cross_5),
