...
wire [d-1:0] m24_3;
wire [d-1:0] m25_3;
wire [d-1:0] m25_cross_3;
wire [d-1:0] m25_inner_3;
wire [d-1:0] m26_3;
wire [d-1:0] m27_2;
wire [d-1:0] m27_3;
wire [d-1:0] m28_3;
...
wire [d-1:0] m31_3;
wire [d-1:0] m31_cross_3;
wire [d-1:0] m31_inner_3;
wire [d-1:0] m32_4;
...
wire [d-1:0] m33_4;
wire [d-1:0] m34_3;
wire [d-1:0] m34_cross_3;
wire [d-1:0] m34_inner_3;
wire [d-1:0] m35_4;
...
MSKand_hpc2_cross_swapped #(.d(d)) comp_m1_cross_2 (
    .out(m1_cross_2),
...
MSKand_hpc2_cross_swapped #(.d(d)) comp_m2_cross_2 (
    .out(m2_cross_2),
...
MSKand_hpc2_cross_swapped #(.d(d)) comp_m4_cross_2 (
    .out(m4_cross_2),
...
MSKand_hpc3_cross_er_swapped #(.d(d)) comp_m25_cross_3 (
    .out(m25_cross_3),
    .rnd(rnd_2[0 +: 1*d*(d-1)]),
    .ina(m22_2),
    .inb(m20_2),
...
MSKand_sharewise #(.d(d)) comp_m25_inner_3 (
    .out(m25_inner_3),
    .ina(m22_3),
    .inb(m20_3)
);
MSKand_hpc2_cross #(.d(d)) comp_m29_cross_4 (
    .out(m29_cross_4),
...
MSKand_hpc2_cross #(.d(d)) comp_m30_cross_4 (
    .out(m30_cross_4),
...
MSKand_hpc3_cross_er #(.d(d)) comp_m31_cross_3 (
    .out(m31_cross_3),
    .rnd(rnd_2[1*(1*d*(d-1))+2*(1*d*(d-1)/2) +: 1*d*(d-1)]),
    .ina(m20_2),
    .ina_prev(m20_3),
    .inb(m23_2),
    .clk(clk)
);
MSKand_sharewise #(.d(d)) comp_m31_inner_3 (
    .out(m31_inner_3),
    .ina(m20_3),
    .inb(m23_3)
);
MSKand_hpc2_cross_swapped #(.d(d)) comp_m32_cross_4 (
    .out(m32_cross_4),
    .rnd(rnd_2[2*(1*d*(d-1))+2*(1*d*(d-1)/2) +: 1*d*(d-1)/2]),
    .ina(m27_2),
    .inb(m31_3),
    .clk(clk)
);
...
MSKand_hpc3_cross_er #(.d(d)) comp_m34_cross_3 (
    .out(m34_cross_3),
    .rnd(rnd_2[2*(1*d*(d-1))+3*(1*d*(d-1)/2) +: 1*d*(d-1)]),
    .ina(m21_2),
    .ina_prev(m21_3),
    .inb(m22_2),
    .clk(clk)
);
MSKand_sharewise #(.d(d)) comp_m34_inner_3 (
    .out(m34_inner_3),
    .ina(m21_3),
    .inb(m22_3)
);
MSKand_hpc2_cross_swapped #(.d(d)) comp_m35_cross_4 (
    .out(m35_cross_4),
...
MSKand_hpc2_cross #(.d(d)) comp_m46_cross_5 (
    .out(m46_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m47_cross_5 (
    .out(m47_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m48_cross_5 (
    .out(m48_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m49_cross_5 (
    .out(m49_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m50_cross_5 (
    .out(m50_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m51_cross_5 (
    .out(m51_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m52_cross_5 (
    .out(m52_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m53_cross_5 (
    .out(m53_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m54_cross_5 (
    .out(m54_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m55_cross_5 (
    .out(m55_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m56_cross_5 (
    .out(m56_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m57_cross_5 (
    .out(m57_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m58_cross_5 (
    .out(m58_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m59_cross_5 (
    .out(m59_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m60_cross_5 (
    .out(m60_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m61_cross_5 (
    .out(m61_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m62_cross_5 (
    .out(m62_cross_5),
...
MSKand_hpc2_cross #(.d(d)) comp_m63_cross_5 (
    .out(m63_cross_5),
