...
void sbox(int x0_0, int x0_1, int x1_0, int x1_1, int x2_0, int x2_1, int x3_0, int x3_1, int *output_0, int *output_1, int dec_1, int dec_0, int dec_2, int dec_3, int rand_2, int rand_3, int rand_1, int rand_4)
{
  ...
  int X0_0;
  int X0_1;
  X0_0 = x1_inp_0 & dec_1_inp;
  X0_1 = x1_inp_1 & dec_1_inp;
  int temp_var_0_0;
  int temp_var_0_1;
  ...
  int X3_0;
  int X3_1;
  X3_0 = (~x2_inp_0) & dec_1_inp;
  X3_1 = x2_inp_1 & dec_1_inp;
  int temp_var_2_0;
  int temp_var_2_1;
  ...
  int Q2_0;
  int Q2_1;
  Q2_0 = temp_var_4_0 & dec_1_inp;
  Q2_1 = temp_var_4_1 & dec_1_inp;
  int T1_0;
  int T1_1;
  ...
  int temp_var_5_0;
  int temp_var_5_1;
  temp_var_5_0 = O0_0 << dec_0_inp;
  temp_var_5_1 = O0_1 << dec_0_inp;
  int temp_var_6_0;
  int temp_var_6_1;
  ...
  int temp_var_8_0;
  int temp_var_8_1;
  temp_var_8_0 = O2_0 << dec_2_inp;
  temp_var_8_1 = O2_1 << dec_2_inp;
  int temp_var_9_0;
  int temp_var_9_1;
  ...
  int temp_var_10_0;
  int temp_var_10_1;
  temp_var_10_0 = O3_0 << dec_3_inp;
  temp_var_10_1 = O3_1 << dec_3_inp;
...
void sbox(int x0_0, int x0_1, int x1_0, int x1_1, int x2_0, int x2_1, int x3_0, int x3_1, int *output_0, int *output_1, int dec_1, int dec_0, int dec_2, int dec_3, int rand_2, int rand_3, int rand_1, int rand_4)
{
  ...
  int temp_var_0_0;
  int temp_var_0_1;
  temp_var_0_0 = x0_0 ^ x2_0;
  temp_var_0_1 = x0_1 ^ x2_1;
  int X1_0;
  int X1_1;
  ...
  int temp_var_1_0;
  int temp_var_1_1;
  temp_var_1_0 = x2_0 ^ x3_0;
  temp_var_1_1 = x2_1 ^ x3_1;
  int X2_0;
  int X2_1;
