...
void fun2(int a_0, int a_1, int b_0, int b_1, int c_0, int c_1, int d_0, int d_1, int *r_0, int *r_1, int rand_3, int rand_6, int rand_5, int rand_2, int rand_1, int rand_4,int rand_7)
{
  int a_inp_0;
  int a_inp_1;
  int b_inp_0;
  ...
  int e_0;
  int e_1;
  HPC2(a_inp_0, a_inp_1, b_inp_0, b_inp_1, &y_0, &y_1, rand_1);
  HPC2(y_0, y_1, b_inp_0, b_inp_1, &z_0, &z_1, rand_2);
  HPC2(y_0, y_1, c_inp_0, c_inp_1, &x_0, &x_1, rand_3);
  // t_0 = (~y_0) & d_inp_0;
  // t_1 = (y_1) & d_inp_1;
  int neg_y_0;
  neg_y_0 = (~y_0);
  HPC2(neg_y_0, y_1, d_inp_0, d_inp_1, &t_0, &t_1, rand_7);
  
  HPC2(z_0, z_1, x_0, x_1, &p_0, &p_1, rand_4);
  HPC2(t_0, t_1, d_inp_0, d_inp_1, &q_0, &q_1, rand_5);
  HPC2(p_0, p_1, q_0, q_1, &e_0, &e_1, rand_6);
  *r_0 = e_0 ^ q_0;
  *r_1 = e_1 ^ q_1;
}
...
int main() {
    ...
    // Write CSV header
    fprintf(fp, "a_0,a_1,b_0,b_1,c_0,c_1,d_0,d_1,rand_1,rand_2,rand_3,rand_4,rand_5,rand_6,rand_7,a,b,c,d,out,out2\n");
    ...
    for (int i = 0; i < ROWS; i++) {
        ...
        int rand_2 = rand_1; //rand() % (MAX_VAL + 1);
        int rand_3 = rand_1; //rand() % (MAX_VAL + 1);
        int rand_4 = rand_1; //rand() % (MAX_VAL + 1);
        int rand_5 = rand_1; //rand() % (MAX_VAL + 1);
        int rand_6 = rand_1; //rand() % (MAX_VAL + 1);
        int rand_7 = rand() % (MAX_VAL + 1);
        // int rand_8 = rand() % (MAX_VAL + 1);
        int w_0;
        int w_1;
        fun2(a_0,a_1,b_0,b_1,c_0,c_1,d_0,d_1,&w_0,&w_1,rand_1,rand_2,rand_3,rand_4,rand_5,rand_6,rand_7);
        int out2 = w_0 ^ w_1;
        ...
        fprintf(fp, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
                a_0, a_1, b_0, b_1, c_0, c_1, d_0, d_1, rand_1, rand_2, rand_3, rand_4, rand_5, rand_6,rand_7, a, b, c, d, out, out2);
    }
