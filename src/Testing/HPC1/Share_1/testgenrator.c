...
#define ROWS 700   // number of rows to generate
...
int main() {
    ...
    // Write CSV header
    fprintf(fp, "a0,a1,b0,b1,rand_0,prand_01,a,b,c\n");
    ...
    for (int i = 0; i < ROWS; i++) {
        ...
        int rand_0 = rand() % (MAX_VAL + 1);
        int prand_01 = rand() % (MAX_VAL + 1);
        int a = a0 ^ a1;
        int b = b0 ^ b1;
        int c = a & b;

        fprintf(fp, "%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
                a0, a1, b0, b1, rand_0, prand_01, a, b, c);
    }
