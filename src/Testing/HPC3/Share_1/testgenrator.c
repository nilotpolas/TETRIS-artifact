...
#define MAX_VAL 200 // max random value (8-bit numbers)
...
int main() {
    ...
    // Write CSV header
    fprintf(fp, "a0,a1,b0,b1,r01,p01,a,b,c\n");
    ...
    for (int i = 0; i < ROWS; i++) {
        ...
        int r01 = (rand() % (MAX_VAL + 1));
        int p01 = (rand() % (MAX_VAL + 1));
        // int dec_2 = 2;
