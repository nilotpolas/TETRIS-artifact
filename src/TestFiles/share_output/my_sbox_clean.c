...
void sbox(int x0_0, int x0_1, int x1_0, int x1_1, int x2_0, int x2_1, int x3_0, int x3_1, int *output_0, int *output_1, int dec_1, int dec_0, int dec_2, int dec_3, int rand_3, int rand_2, int rand_1, int rand_4)
{
