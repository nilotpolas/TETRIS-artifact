...
void hpc2(int a0, int a1, int b0, int b1, int *y0, int *y1, int r)
{
    int r0;
    r0 = r % 2;
    int u0, u1, i0, i1, v0, v1, p0, p1, p01, p2, p3, p23, a0_neg, a1_neg;
    a0_neg = !a0;
    a1_neg = !a1;
    u0 = a0_neg & reg(r0);
    u1 = a1_neg & reg(r0);
...
void G4_mul(int x0, int x1, int y0, int y1, int *e0_0, int *e1_0, int r0, int r1, int r2)
{
    ...
    hpc2(axorb_0, axorb_1, cxord_0, cxord_1, &e0, &e1, r00);

    hpc2(a0, a1, c0, c1, &p0_0, &p1_0, r10);
    p0 = p0_0 ^ e0;
    p1 = p1_0 ^ e1;

    hpc2(b0, b1, d0, d1, &q0_0, &q1_0, r20);
    q0 = q0_0 ^ e0;
    q1 = q1_0 ^ e1;
    int p0ls1, p1ls1;
    p1ls1 = p1 << 1;
...
void G4_scl_N2(int x0, int x1, int *e0_0, int *e1_0)
{
...
void G256_inv(int x0, int x1, int *y0, int *y1, int r0, int r1, int r2, int r3, int r4, int r5, int r6, int r7, int r8,
...
void G256_newbasis(int in1, int in2, int b[], int *out1, int *out2)
{
