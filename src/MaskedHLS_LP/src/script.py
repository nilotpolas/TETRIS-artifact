...
def main():
    # --- Clear tempFiles at the start ---
    if os.path.exists(TEMP_FILES_DIR):
        shutil.rmtree(TEMP_FILES_DIR)
    os.makedirs(TEMP_FILES_DIR)

    argparser = argparse.ArgumentParser()
    argparser.add_argument('--topModule', default='none', help='The top module of design')
    argparser.add_argument('--inputFile', default='none', help='Name of the balanced design')
    argparser.add_argument('--rtlFile', default='./output.v', help='Name of the RTL output file')
    argparser.add_argument('--bitWidth', default='1', help='Bit-width for the RTL file')
    argparser.add_argument('--mode', default=0, type=int, help='Wheather or not to do hpc2 otimization')
    argparser.add_argument('--checkBalancing', default='0', help='Whether or not to verify the balancing')
    ...
    systemArgs = {
        ...
        "checkBalancing": 0,
        "turn": 1  # default value; adjust if needed
    }
    ...
    if args.mode == 0:
        ...
        # run_script("./PostProcessor/redundancy_remover.py")
        run_script("./Compiler/parser_1.py")

        # Second RegBalancer run for balancing check
